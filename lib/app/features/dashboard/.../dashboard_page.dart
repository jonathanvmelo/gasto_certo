...
//   getUser() async {
//     user = await sessonUser.readOne(key: 'CURRENT_USER');
//   }
...
//                 ),
//                 Text(
//                   Functions.currencyFormatter().format(500),
...
//                               const Text('Receitas'),
//                               Text(
//                                 Functions.currencyFormatter().format(1500),
...
//   //TODO #1 criar logica para colocar cores nos valors positivos e negativos
...
//         ),
//         trailing: Text(
//             Functions.currencyFormatter().format(e.amount!).toString(),
//             style: AppTextStyle.mediumText18),
//       );
//     }).toList();
//   }
